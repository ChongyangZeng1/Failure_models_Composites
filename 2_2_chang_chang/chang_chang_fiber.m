...
chang_fiber1 = (sigma1.^2)/(Xt.^2) + beta*(tau12.^2)/(Sc.^2);
...
print(gcf,'-dtiffn','chang_fiber_1')
view([0 90]);
print(gcf,'-dtiffn','chang_fiber_2')
view([0 1]);
colorbar off
print(gcf,'-dtiffn','chang_fiber_3')
view([-90 1]);
colorbar off
print(gcf,'-dtiffn','chang_fiber_4')
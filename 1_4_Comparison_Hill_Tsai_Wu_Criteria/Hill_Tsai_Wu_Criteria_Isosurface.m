...
Tsai_hill = (sigma1.^2)/(ft1.^2) + (sigma2.^2)/(ft2.^2) + (tau12.^2)/(fv4.^2) -...
    (sigma1.*sigma2./(ft1.^2));
...
%%
h2 = patch(isosurface(sigma1, sigma2, tau12, Tsai_hill, isosurface_threshold));
hold on;
isonormals(sigma1, sigma2, tau12,Tsai_hill,h2)
...
%%
h3 = patch(isosurface(sigma1, sigma2, tau12, Tsai_Wu, isosurface_threshold));
hold on;
isonormals(sigma1, sigma2, tau12,Tsai_Wu,h3)
...
print(gcf,'-dtiffn','Hill_Tasi_Wu_1')
view([0 90]);
print(gcf,'-dtiffn','Hill_Tasi_Wu_2')
view([0 0]);
colorbar off
print(gcf,'-dtiffn','Hill_Tasi_Wu_3')
...
h1 = patch(isosurface(sigma1, sigma2, tau12, Tsai_hill, isosurface_threshold));
% set(h1, 'FaceColor', 'b', 'EdgeColor', 'none', 'FaceAlpha', 0.3);
hold on;

isonormals(sigma1, sigma2, tau12,Tsai_hill,h1)
...
print(gcf,'-dtiffn','Tasi_Hill_1')
view([0 90]);
print(gcf,'-dtiffn','Tasi_Hill_2')
view([0 0]);
colorbar off
print(gcf,'-dtiffn','Tasi_Hill_3')